...
<body>
	...
	<form:form action="saveRide" modelAttribute="ride" method="POST">
		...
		<div class="container-fluid">
			...
			<h2 class="text-center title">One Way Ride<a href="${pageContext.request.contextPath}/showRideForm" class="float-right"><button type="button" class="btn btn-primary">Round trip</button></a></h2>
